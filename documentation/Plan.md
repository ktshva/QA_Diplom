...
3. Ввести валидные данные карты в появившихся полях (номер карты: 4444 4444 4444 4441, месяц: 04, год: 24, Владелец: Ivan Petrov, CVC/CVV: 999)
...
1. Открыть в браузере страницу http://localhost:8080/
2. Нажать на кнопку "Купить"
3. Ввести валидные данные карты в появившихся полях (номер карты: 4444 4444 4444 4442, месяц: 04, год: 24, Владелец: Ivan Petrov, CVC/CVV: 999)
4. Нажать на кнопку "Продолжить"
...
1. Открыть в браузере страницу http://localhost:8080/
2. Нажать на кнопку "Купить"
3. Ввести валидные данные карты в появившихся полях, кроме номера карты (номер карты: 4444 4444 4444, месяц: 04, год: 24, Владелец: Ivan Petrov, CVC/CVV: 999)
4. Нажать на кнопку "Продолжить"
...
1. Открыть в браузере страницу http://localhost:8080/
2. Нажать на кнопку "Купить"
3. Ввести валидные данные карты в появившихся полях (номер карты: 4444 4444 4444 4443, месяц: 04, год: 24, Владелец: Ivan Petrov, CVC/CVV: 999)
4. Нажать на кнопку "Продолжить"
...
1. Открыть в браузере страницу http://localhost:8080/
2. Нажать на кнопку "Купить"
3. Ввести валидные данные карты в появившихся полях, кроме года (номер карты: 4444 4444 4444 4441, месяц: 04, год: 23, Владелец: Ivan Petrov, CVC/CVV: 999)
4. Нажать на кнопку "Продолжить"
...
1. Открыть в браузере страницу http://localhost:8080/
2. Нажать на кнопку "Купить"
3. Ввести валидные данные карты в появившихся полях, кроме года (номер карты: 4444 4444 4444 4441, месяц: 04, год: 30, Владелец: Ivan Petrov, CVC/CVV: 999)
4. Нажать на кнопку "Продолжить"
...
1. Открыть в браузере страницу http://localhost:8080/
2. Нажать на кнопку "Купить"
3. Ввести валидные данные карты в появившихся полях, кроме владельца (номер карты: 4444 4444 4444 4441, месяц: 04, год: 24, Владелец: ******, CVC/CVV: 999)
4. Нажать на кнопку "Продолжить"
...
1. Открыть в браузере страницу http://localhost:8080/
2. Нажать на кнопку "Купить"
3. Ввести валидные данные карты в появившихся полях, кроме владельца (номер карты: 4444 4444 4444 4441, месяц: 04, год: 24, Владелец: Иван Петров, CVC/CVV: 999)
4. Нажать на кнопку "Продолжить"
...
1. Открыть в браузере страницу http://localhost:8080/
2. Нажать на кнопку "Купить"
3. Ввести валидные данные карты в появившихся полях, кроме CVC/CVV (номер карты: 4444 4444 4444 4441, месяц: 04, год: 24, Владелец: Ivan Petrov, CVC/CVV: 99)
4. Нажать на кнопку "Продолжить"
